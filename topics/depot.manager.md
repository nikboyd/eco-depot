...
In the context of this [model](../domain-inventory.md), a [depot manager][depot.manager]

<img align="right" src="../images/depot_manager_monitors.svg" />

<ul>
 <li><i>monitors</i> a <a href="depot.md">depot</a> for a <a href="depot.vulnerability.md">depot vulnerability</a></li>
 <li> </li>
 <li> </li>
 <li> </li>
 <li> </li>
...
See **Derivations** and **Definitions** in [Company Regulation](company.regulation.md#derivations)
