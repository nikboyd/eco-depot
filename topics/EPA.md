...
In the context of this [model](../domain-inventory.md), an [EPA][EPA]

<img align="right" src="../images/EPA_equals.svg" />

<ul>
 <li><i>equals</i> an <a href="environmental.protection.agency.md">environmental protection agency</a></li>
 <li> </li>
 <li> </li>
 <li> </li>
 <li> </li>
...
<img align="right" src="../images/EPA_publishes.svg" />

<ul>
 <li><i>publishes</i> some <a href="hazardous.chemical.storage.regulation.md">hazardous chemical storage regulations</a></li>
 <li> </li>
 <li> </li>
 <li> </li>
 <li> </li>
...
<img align="right" src="../images/EPA_regulates.svg" />

<ul>
 <li><i>regulates</i> some <a href="hazardous.chemical.storage.facility.md">hazardous chemical storage facilities</a></li>
 <li> </li>
 <li> </li>
 <li> </li>
 <li> </li>
...
<img align="right" src="../images/EPA_classifies.svg" />

<ul>
 <li><i>classifies</i> an <a href="hazardous.chemical.md">hazardous chemical</a> with an <a href="hazard.type.md">hazard type</a></li>
 <li> </li>
 <li> </li>
 <li> </li>
 <li> </li>
...
<img align="right" src="../images/EPA_issues.svg" />

<ul>
 <li><i>issues</i> a <a href="drum.storage.license.md">drum storage license</a> per an <a href="hazard.type.md">hazard type</a> per a <a href="storage.building.md">storage building</a></li>
 <li> </li>
 <li> </li>
 <li> </li>
 <li> </li>
...
See [EPA regulation](EPA.regulation.md#narrative-source).
