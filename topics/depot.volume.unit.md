...
In the context of this [model](../domain-inventory.md), a [depot volume unit][depot.volume.unit]

<img align="right" src="../images/depot_volume_unit_extends.svg" />
...
<img align="right" src="../images/depot_volume_unit_measures.svg" />

<ul>
 <li><i>measures</i> some <a href="gallon.md">gallons</a></li>
 <li> </li>
 <li> </li>
 <li> </li>
 <li> </li>
