...
In the context of this [model](../domain-inventory.md), a [drum description][drum.description]

<img align="right" src="../images/drum_description_has.svg" />

<ul>
 <li><i>has</i> a <a href="drum.identifier.md">drum identifier</a> and a <a href="chemical.description.md">chemical description</a></li>
 <li> </li>
 <li> </li>
 <li> </li>
 <li> </li>
