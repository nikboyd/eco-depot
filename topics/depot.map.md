...
In the context of this [model](../domain-inventory.md), a [depot map][depot.map]

<img align="right" src="../images/depot_map_finds.svg" />

<ul>
 <li><i>finds</i> a <a href="building.md">building</a> in a <a href="depot.md">depot</a> with a <a href="location.md">location</a></li>
 <li> </li>
 <li> </li>
 <li> </li>
 <li> </li>
...
<img align="right" src="../images/depot_map_names.svg" />

<ul>
 <li><i>names</i> a <a href="building.md">building</a> in a <a href="depot.md">depot</a> with a <a href="name.md">name</a></li>
 <li> </li>
 <li> </li>
 <li> </li>
 <li> </li>
...
See **Additional Concepts** in [Depot Building][map-concept]

[map-concept]:depot.building.md#additional-concepts
