...
In the context of this [model](../domain-inventory.md), a [building description][building.description]

<img align="right" src="../images/building_description_has.svg" />

<ul>
 <li><i>has</i> a <a href="name.md">name</a> and a <a href="perimeter.md">perimeter</a> and a <a href="location.md">location</a></li>
 <li> </li>
 <li> </li>
 <li> </li>
 <li> </li>
