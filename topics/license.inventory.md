...
In the context of this [model](../domain-inventory.md), a [license inventory][license.inventory]

<img align="right" src="../images/license_inventory_records.svg" />

<ul>
 <li><i>records</i> some <a href="drum.storage.license.description.md">drum storage license descriptions</a></li>
 <li> </li>
 <li> </li>
 <li> </li>
 <li> </li>
...
<img align="right" src="../images/license_inventory_locates.svg" />

<ul>
 <li><i>locates</i> some <a href="drum.storage.license.md">drum storage licenses</a> per a <a href="storage.building.md">storage building</a></li>
 <li> </li>
 <li> </li>
 <li> </li>
 <li> </li>
...
See [Drum Storage License][storage-license]

[storage-license]:drum.storage.license.md#narrative-source
