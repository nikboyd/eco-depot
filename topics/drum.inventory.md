...
In the context of this [model](../domain-inventory.md), a [drum inventory][drum.inventory]

<img align="right" src="../images/drum_inventory_records.svg" />

<ul>
 <li><i>records</i> some <a href="drum.description.md">drum descriptions</a></li>
 <li> </li>
 <li> </li>
 <li> </li>
 <li> </li>
...
<img align="right" src="../images/drum_inventory_locates.svg" />

<ul>
 <li><i>locates</i> some <a href="drum.md">drums</a> per a <a href="storage.building.md">storage building</a></li>
 <li> </li>
 <li> </li>
 <li> </li>
 <li> </li>
...
<img align="right" src="../images/drum_inventory_counts.svg" />

<ul>
 <li><i>counts</i> some <a href="drum.md">drums</a> per an <a href="hazard.type.md">hazard type</a></li>
 <li> </li>
 <li> </li>
 <li> </li>
 <li> </li>
