...
In the context of this [model](../domain-inventory.md), a [depot weight unit][depot.weight.unit]

<img align="right" src="../images/depot_weight_unit_extends.svg" />
...
<img align="right" src="../images/depot_weight_unit_measures.svg" />

<ul>
 <li><i>measures</i> some <a href="pound.md">pounds</a></li>
 <li> </li>
 <li> </li>
 <li> </li>
 <li> </li>
