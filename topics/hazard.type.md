...
In the context of this [model](../domain-inventory.md), an [hazard type][hazard.type]

<img align="right" src="../images/hazard_type_equals.svg" />

<ul>
 <li><i>equals</i> an <a href="EPA.hazard.type.md">EPA hazard type</a></li>
 <li> </li>
 <li> </li>
 <li> </li>
 <li> </li>
...
<img align="right" src="../images/hazard_type_contains.svg" />

<ul>
 <li><i>contains</i> a <a href="type1.md">type1</a> and a <a href="type2.md">type2</a> and a <a href="type3.md">type3</a></li>
 <li> </li>
 <li> </li>
 <li> </li>
 <li> </li>
...
See [Safety Violation][safety-violation]

[safety-violation]:safety.violation.md#narrative-source
