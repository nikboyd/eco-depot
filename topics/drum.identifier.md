...
In the context of this [model](../domain-inventory.md), a [drum identifier][drum.identifier]

<img align="right" src="../images/drum_identifier_identifies.svg" />

<ul>
 <li><i>identifies</i> a <a href="drum.md">drum</a> in a <a href="depot.md">depot</a></li>
 <li> </li>
 <li> </li>
 <li> </li>
 <li> </li>
