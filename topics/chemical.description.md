...
In the context of this [model](../domain-inventory.md), a [chemical description][chemical.description]

<img align="right" src="../images/chemical_description_has.svg" />

<ul>
 <li><i>has</i> a <a href="name.md">name</a> and a <a href="volume.md">volume</a> and a <a href="weight.md">weight</a> and an <a href="hazard.type.md">hazard type</a></li>
 <li> </li>
 <li> </li>
 <li> </li>
 <li> </li>
...
See [Hazardous Chemical](hazardous.chemical.md)

### Implications

Each chemical [drum][drum] is labeled with its description:

* chemical name
* volume (in gallons, the [depot volume unit][depot.volume.unit])
* weight (in pounds, the [depot weight unit][depot.weight.unit])
