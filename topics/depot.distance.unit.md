...
In the context of this [model](../domain-inventory.md), a [depot distance unit][depot.distance.unit]

<img align="right" src="../images/depot_distance_unit_extends.svg" />

<ul>
 <li><i>extends</i> an <a href="unit.md">unit</a></li>
 <li> </li>
 <li> </li>
 <li> </li>
 <li> </li>
...
<img align="right" src="../images/depot_distance_unit_measures.svg" />

<ul>
 <li><i>measures</i> a <a href="feet.md">feet</a></li>
 <li> </li>
 <li> </li>
 <li> </li>
 <li> </li>
