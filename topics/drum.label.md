...
In the context of this [model](../domain-inventory.md), a [drum label][drum.label]

<img align="right" src="../images/drum_label_shows.svg" />

<ul>
 <li><i>shows</i> a <a href="drum.description.md">drum description</a></li>
 <li> </li>
 <li> </li>
 <li> </li>
 <li> </li>
