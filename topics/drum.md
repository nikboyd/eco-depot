...
In the context of this [model](../domain-inventory.md), a [drum][drum]

<img align="right" src="../images/drum_equals.svg" />

<ul>
 <li><i>equals</i> an <a href="hazardous.chemical.storage.drum.md">hazardous chemical storage drum</a></li>
 <li> </li>
 <li> </li>
 <li> </li>
 <li> </li>
...
<img align="right" src="../images/drum_contains.svg" />

<ul>
 <li><i>contains</i> an <a href="hazardous.chemical.md">hazardous chemical</a></li>
 <li> </li>
 <li> </li>
 <li> </li>
 <li> </li>
